...
public class Topic_07_Textbox_Textarea {
    ...
    public void TC_06_validateLogin() {
        ...
        driver.findElement(By.xpath("//div[@class='oxd-form-row user-form-header']/following-sibling::div[1]//input[@class='oxd-input oxd-input--active']")).sendKeys("AutomationFC");
        driver.findElement(By.xpath("//div[@class='oxd-grid-item oxd-grid-item--gutters user-password-cell']//input")).sendKeys("123456");
        driver.findElement(By.xpath("//div[@class='oxd-grid-item oxd-grid-item--gutters user-password-cell']/following-sibling::div//input")).sendKeys("123456");
        driver.findElement(By.xpath("//button[@type='submit']")).click();
